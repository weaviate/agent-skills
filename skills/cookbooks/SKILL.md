...
- [Query Agent Chatbot](references/query_agent_chatbot.md): Build a full-stack Next.js + FastAPI chatbot using Weaviate Query Agent with streaming and chat history support.
